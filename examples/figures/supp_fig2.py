...
from ephysatlas.unit_level_encoder.figure_unit_common import load_released_unit_model
...
def make_supp_figure2(fig_cfg=FigureConfig()):
    figure_style()
    cfg,data,model_ae,model_gmm,scaler,standardized,datasets,loaders,_=load_released_unit_model(fig_cfg.repo_id,fig_cfg.vintage,token=fig_cfg.token)
