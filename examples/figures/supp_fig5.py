...
def resolve_alignment_release(
    *,
    ...
    # the same artifacts his registry did; the body below is unchanged, except that the weights now
    # sit at the release-dir root rather than under models/channel.
