...
class BaseFeatureCalculator(abc.ABC):
    ...
    def _resolve_feature_names(
        ...
        if requested is None:
            ...
            invalid = [feature for feature in requested if feature not in AVAILABLE_FEATURES]
            if invalid:
                raise ValueError(
        ...
        if not feature_names:
            raise ValueError("No requested feature families match the available streams")
    ...
    def _apply_selective_provenance(
        ...
        for feature_name in computed_features:
            ...
            with lock:
                ...
                tmp_file = file_path.with_suffix(file_path.suffix + f".{os.getpid()}.tmp")
